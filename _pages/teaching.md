...
-	Jin Li (M.Sc, 2022, Graduated), Multi-robot formation reconfiguration and path planning, RA-L * 1, ICUS * 1
-	Peng Qi (M.Sc, 2023), DRL-based autonomous robot exploration, ICRA*1 (submitted)
-	Shaohao Zhu (Ph.D., 2022), DRL-based multi-robot exploration, ICRA*1,  IJRR * 1 (submitted)
-	Yixian Zhao (Ph.D., 2021), Multi-robot SLAM, T-ASE*1(submitted)
-	Jing Zeng (Ph.D., 2019), Multi-robot active 3D reconstruction, RA-L * 1, IOT-J * 1
